...
// RegisterInternalFlagLoggerServiceHandlerServer registers the http handlers for service InternalFlagLoggerService to "mux".
// UnaryRPC     :call InternalFlagLoggerServiceServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
// Note that using this registration option will cause many gRPC library features to stop working. Consider using RegisterInternalFlagLoggerServiceHandlerFromEndpoint instead.
...
// RegisterInternalFlagLoggerServiceHandlerFromEndpoint is same as RegisterInternalFlagLoggerServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterInternalFlagLoggerServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterInternalFlagLoggerServiceHandler(ctx, mux, conn)
}

// RegisterInternalFlagLoggerServiceHandler registers the http handlers for service InternalFlagLoggerService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterInternalFlagLoggerServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterInternalFlagLoggerServiceHandlerClient(ctx, mux, NewInternalFlagLoggerServiceClient(conn))
}

// RegisterInternalFlagLoggerServiceHandlerClient registers the http handlers for service InternalFlagLoggerService
// to "mux". The handlers forward requests to the grpc endpoint over the given implementation of "InternalFlagLoggerServiceClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "InternalFlagLoggerServiceClient"
