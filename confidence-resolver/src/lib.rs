...
#[cfg(feature = "std")]
pub use pbjson_types::{value::Kind, Struct, Timestamp, Value};
#[cfg(not(feature = "std"))]
pub use prost_types::{value::Kind, Struct, Timestamp, Value};
...
use confidence::flags::resolver::v1 as flags_resolver;
use confidence::flags::resolver::v1::resolve_token_v1::AssignedFlag;
use confidence::iam::v1 as iam;
...
mod tests {
    use super::*;
    use crate::confidence::flags::resolver::v1::{ResolveFlagsResponse, Sdk};
