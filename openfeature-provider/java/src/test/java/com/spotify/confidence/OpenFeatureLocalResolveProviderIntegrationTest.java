...
class OpenFeatureLocalResolveProviderIntegrationTest {
    ...
    void setUp() throws Exception {
        ...
        httpServer.createContext("/resolver_state.pb", exchange -> {
            try {
                final byte[] stateBytes = Files.readAllBytes(
    ...
    void testResolveTutorialFeatureFlag() throws Exception {
        ...
        assertThat(evaluation.getVariant()).isEqualTo("flags/tutorial-feature/variants/exciting-welcome");
        assertThat(evaluation.getValue().asStructure().asMap()).containsExactlyInAnyOrderEntriesOf(
                Map.of("title", new Value("Welcome to Confidence!"),
                        "message", new Value("We are very excited to welcome you to Confidence! This is a message from the tutorial flag."))
        );
    ...
    /**
     * Mock FlagLoggerService that accepts flag logs
     */
