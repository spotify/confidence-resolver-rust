 ...
 *
 * <p>This implementation polls the resolver state service for flag configurations, using ETags for
 * conditional GETs to minimize bandwidth. The state is fetched via signed URIs with automatic
