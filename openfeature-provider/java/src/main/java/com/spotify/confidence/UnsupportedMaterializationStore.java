...
/**
 * A store that doesn't support the feature and where the provider resorts to use gRPC to resolve flags when the WASM resolver
 * encounters missing materializations. This provides a fallback to the remote Confidence service.
 */
