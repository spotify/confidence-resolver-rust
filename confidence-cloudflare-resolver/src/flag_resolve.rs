...
use confidence_resolver::confidence::flags::admin::v1::context_field_semantic_type::country_semantic_type::CountryFormat;
use confidence_resolver::confidence::flags::admin::v1::context_field_semantic_type::{CountrySemanticType, DateSemanticType, TimestampSemanticType, VersionSemanticType};
use confidence_resolver::confidence::flags::admin::v1::{context_field_semantic_type, evaluation_context_schema_field, ClientResolveInfo, ContextFieldSemanticType, FlagResolveInfo};
use confidence_resolver::{Kind, Struct, Value};
...
pub struct DerivedClientSchema {
    pub fields: HashMap<String, evaluation_context_schema_field::Kind>,
    pub semantic_types: HashMap<String, ContextFieldSemanticType>,
}
...
impl SchemaFromEvaluationContext {
    ...
    fn flattened_schema(
        struct_value: &Struct,
        field_path: &str,
        flat_schema: &mut HashMap<String, evaluation_context_schema_field::Kind>,
        semantic_types: &mut HashMap<String, ContextFieldSemanticType>,
    ) {
...
fn get_iso_country_codes() -> HashSet<&'static str> {
